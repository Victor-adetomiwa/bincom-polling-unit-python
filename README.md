...
## Note
This project uses the Bincom test database locally.
Due to deployment limitations, database-backed features
are demonstrated locally but code is fully implemented.
